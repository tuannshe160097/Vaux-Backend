...
{
    /// <inheritdoc />
    public partial class AucSessionCron : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
				...
				/****** Object:  Job [vaux_start_auction]    Script Date: 10/31/2023 9:18:10 PM ******/
				BEGIN TRANSACTION
				DECLARE @ReturnCode INT
				SELECT @ReturnCode = 0
				/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 10/31/2023 9:18:10 PM ******/
				...
				EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'vaux_start_auction', 
						@enabled=1, 
						...
						@owner_login_name=N'DESKTOP-NH7N4F7\Meka', @job_id = @jobId OUTPUT
				IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
				/****** Object:  Step [update_item_status_4]    Script Date: 10/31/2023 9:18:10 PM ******/
				EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'update_item_status_4', 
						@step_id=1, 
				...
				IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
				EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'daily_morning', 
						@enabled=1, 
						@freq_type=4, 
						@freq_interval=1, 
						@freq_subday_type=1, 
						...
						@schedule_uid=N'5d8d4b94-ddf0-48f0-a2ef-6f61671207f2'
				IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
